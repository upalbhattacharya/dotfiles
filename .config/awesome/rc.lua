...
clientkeys = mytable.join(
	...
	awful.key({ modkey, "Control" }, "o", function()
		cycle_screens()
	end, { description = "swap screens (hacky)", group = "client" }),
	awful.key({ modkey, "Shift" }, "o", function(c)
		move_tag_clients_to_screen(c, c.screen)
	end, { description = "move all clients of active client's tag to screen", group = "client" }),
